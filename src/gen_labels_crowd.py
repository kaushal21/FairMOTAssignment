...
if __name__ == '__main__':
    data_val = 'content/data/crowdhuman/images/val'
    label_val = 'content/data/crowdhuman/labels_with_ids/val'
    ann_val = 'content/data/crowdhuman/annotation_val.odgt'
    data_train = 'content/data/crowdhuman/images/train'
    label_train = 'content/data/crowdhuman/labels_with_ids/train'
    ann_train = 'content/data/crowdhuman/annotation_train.odgt'
